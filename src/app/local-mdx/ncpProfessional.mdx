...
<StudioDiagram doc="ssh-hang" ratio={1.978} caption="요청은 도착했고 응답이 NACL 아웃바운드에서 버려진다" />
...
<StudioDiagram doc="overall" ratio={0.678} caption="엿새 동안 만든 것 — Ops VPC, Workload VPC, K3s, 그리고 NKS" />
...
<StudioDiagram doc="stack" ratio={0.935} caption="실습에서 쌓아 올린 층 — VPC부터 노출과 확장까지" />
