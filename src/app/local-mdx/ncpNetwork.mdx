...
<StudioDiagram doc="day1" ratio={1.64} caption="1일차 구성도 — Ops VPC와 Workload VPC, NAT Gateway, Internet Gateway, VPC Peering" />
...
<StudioDiagram doc="net-direction" ratio={2.669} caption="Internet Gateway는 양쪽이 열리고 NAT Gateway는 나가는 방향만 열린다" />
...
<StudioDiagram doc="net-layers" ratio={0.975} caption="패킷이 통과해야 하는 네 개의 관문" />
