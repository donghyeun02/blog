...
const MILESTONES: readonly Milestone[] = [
  ...
  {
    date: '2026.09',
    title: '도면을 직접 그리는 스튜디오를 만들었다',
    body: '쓰던 다이어그램 사이트들은 필요 없는 도형은 많고 원하는 모양은 없었다. 그래서 ERD, 아키텍처, 흐름도를 끌어다 놓아 만드는 스튜디오를 블로그 안에 따로 두었다. 선에 단계 번호를 매기면 요청이 한 구간씩 흐르고, 막힌 통신은 중간에서 끊겨 보인다. 브라우저에 저장되고 PNG·SVG·JSON으로 내보낼 수 있다. 글에 있던 정적인 도면 17장도 이걸로 전부 바꿔서, 글 안에서 흐름을 재생하고 크게 볼 수 있게 했다.',
    tags: ['React Flow', 'SMIL', 'html-to-image'],
  },
] as const;
