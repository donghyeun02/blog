      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-8 md:px-12 lg:px-16 py-12 sm:py-16 md:py-24 max-w-4xl">
        ...
        >
          <div className="space-y-6 text-sm sm:text-base md:text-lg text-[#E2E6E9] leading-relaxed">
            ...
            <p>
              저에게 글은 그런 &apos;기록&apos;이었습니다. 돌아보면 예전 글들은
              서툴고 부끄럽습니다. 지금 보면 참 못 썼다고 느끼지만, 그때의
              생각과 시선이 담긴 흔적이라는 점에서 그 어떤 글보다 진짜
              같았습니다.
            </p>
            <p>그래서 문득 궁금했습니다.</p>
            ...
            <p>
              저는 글을 단순한 &apos;데이터&apos;가 아닌 &apos;기록&apos;으로
              다루기로 했습니다. 글을 IPFS에 올리고, 그 해시(CID)를 Polygon
              블록체인에 등록했습니다.
            </p>
            <p>
            ...
            <p>
              ...
              기능을 &apos;붙이는 기술&apos;이 아닙니다. 처음부터 신뢰의 구조를
              다시 설계하는 방식입니다.
            </p>
            <p>
              DB에는 &apos;삭제&apos;와 &apos;수정&apos;이 있지만, 블록체인에는
              오직 &apos;추가&apos;만 있습니다. 그 불편함이 곧 기록의 신뢰가
              됩니다.
            </p>
            <p>
