        ...
        <div className="bg-red-50 p-2 sm:p-3 rounded-lg border border-red-200">
          <div className="flex items-center sm:grid sm:grid-cols-4 gap-2 sm:gap-3">
            ...
            <div className="text-center w-16 sm:w-auto">
              ...
              <div className="text-sm sm:text-xl font-bold">{rgbValues.r}</div>
            </div>
            <div className="text-right sm:text-center flex-1 sm:flex-none">
              <div className="text-xs sm:text-sm text-red-600 font-medium">
                2진수
              </div>
              <div className="text-xs sm:text-md font-mono bg-white pl-0 pr-0.5 py-0.5 sm:px-2 sm:py-1 rounded border ml-6 sm:ml-0">
                {binaryValues.r}
              </div>
            </div>
          </div>
        ...
        <div className="bg-green-50 p-2 sm:p-3 rounded-lg border border-green-200">
          <div className="flex items-center sm:grid sm:grid-cols-4 gap-2 sm:gap-3">
            ...
            <div className="text-center w-16 sm:w-auto">
              ...
              <div className="text-sm sm:text-xl font-bold">{rgbValues.g}</div>
            </div>
            <div className="text-right sm:text-center flex-1 sm:flex-none">
              <div className="text-xs sm:text-sm text-green-600 font-medium">
                2진수
        ...
        <div className="bg-blue-50 p-2 sm:p-3 rounded-lg border border-blue-200">
          <div className="flex items-center sm:grid sm:grid-cols-4 gap-2 sm:gap-3">
            ...
            <div className="text-center w-16 sm:w-auto">
              ...
              <div className="text-sm sm:text-xl font-bold">{rgbValues.b}</div>
            </div>
            <div className="text-right sm:text-center flex-1 sm:flex-none">
              <div className="text-xs sm:text-sm text-blue-600 font-medium">
                2진수
